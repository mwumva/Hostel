...
body {
  ...
  background-image: linear-gradient(rgba(177,178,179,0.7),hsla(184, 65%, 40%, 0.623)),url('images/beng.png');
 ...
 <div>
  ...
  <b><h1> login here</h1></b>
      <div class="container">
          ...
          <input type="email" placeholder="Enter your associated email address" name="email" maxlength="50"required>
<br><br><br>
